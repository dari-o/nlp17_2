...
pathToData = workingDirectory+sep+"../works/netflix/data"
...
pathToEmbeddings     = pathToData+sep+"embeddings/Model_+Cornell_size"+str(embedding_size)+".word2vec"
pathToModel         = workingDirectory+sep+sep+"model"
pathToWord2Int      = workingDirectory + sep + "word2int_dictionary.npy"
